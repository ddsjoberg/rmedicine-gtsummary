...
.pull-right[
<p align="center"><img src="images/tbl_uvreg.png" width=85%></p>
]
...
```{r}
tbl_merge_1 <- tbl_merge(list(tbl_uvreg, tbl_logreg),
                         tab_spanner = c("**Univariable**", "**Multivariable**"))
```
```{r, include=FALSE}
my_gtsave("tbl_merge_1")
```
<p align="center"><img src="images/Dan-SummaryTables-6.png" width=68%></p>

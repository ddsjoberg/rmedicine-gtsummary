...
---
background-image: url(images/tbl-regression-markup.png)
...
- Arguments and helper functions like `exponentiate`, `bold_*`, `add_global_p()` are available for `tbl_uvregression()`
